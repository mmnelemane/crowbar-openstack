...
;(function($, doc, win) {
  ...
  ApicPorts.prototype.initialize = function() {
    var self = this;
  ...
  ApicPorts.prototype.visualizePorts = function() {
    var self = this;
  ...
  ApicPorts.prototype.prepareNodes = function() {
    var self = this;
  ...
  ApicPorts.prototype.renderOptions = function() {
    var self = this;
  ...
  ApicPorts.prototype.registerEvents = function() {
    var self = this;
  ...
  ApicPorts.prototype.retrieveSwitches = function() {
  ...
  ApicPorts.prototype.writeJson = function(key, value, type) {
  ...
  ApicPorts.prototype.removeJson = function(key, value, type) {
  ...
  ApicPorts.prototype.visualSwitches = function() {
